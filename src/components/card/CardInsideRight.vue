<template>
  <div class="row">
    ...
    <div class="col-sm-6 card card-display">
      <cc-text-output :display-text="textBoxValue1" :containerHeight="240"></cc-text-output>
      <cc-text-output :display-text="textBoxValue2" :containerHeight="240"></cc-text-output>
      <cc-text-output :display-text="textBoxValue3" :containerHeight="240"></cc-text-output>
    </div>
  </div>
</template>
